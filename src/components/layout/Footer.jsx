        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12 pb-10 border-b border-slate-200/50 dark:border-slate-900">
          ...
          <div className="col-span-1 md:col-span-1.5 space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <a href="https://github.com/anointedthedeveloper" target="_blank" rel="noreferrer" className="p-2 rounded-xl hover:bg-slate-200/50 dark:hover:bg-slate-900 text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors" aria-label="GitHub">
                <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
