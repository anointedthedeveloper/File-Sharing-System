    ...
    >
      <div className="max-w-3xl mx-auto px-4 py-16 sm:py-24 text-left">
        ...
        <div className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-slate-600 dark:text-slate-300 leading-relaxed text-sm sm:text-base">
          <p>
            By accessing or uploading components to the Sharing It file-sharing service, you agree to comply with and be bound by the following terms of use.
          </p>
          ...
          <p>
            Sharing It is provided as-is. We do not charge fees for standard usage tiers but enforce size boundaries: 50MB for guests, and 1GB for registered accounts. We reserve the right to prune inactive or excessively heavy files during cleanups.
          </p>
          ...
          <p>
            We may refine these policies at any time. Continued usage of Sharing It signifies agreement with revised parameters.
          </p>
        </div>
      </div>
    </LayoutContainer>
