...
export default function Landing() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Sharing It supports a high-fidelity Sandbox Mode! If live database credentials are not configured, the app operates locally in your browser memory and LocalStorage. You can test all upload, password protection, QR generation, history tracking, and download previews with absolute zero configurations."
    },
    {
      ...
      <section className="py-20 sm:py-32">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 max-w-2xl mx-auto mb-16">
            ...
            <p className="text-sm sm:text-base text-slate-500 dark:text-slate-400 leading-relaxed">
              Discover what other digital professionals are saying about the Sharing It platform.
            </p>
          </div>
